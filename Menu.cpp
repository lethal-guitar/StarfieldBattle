...
GameMenu::GameMenu(LPDIRECTDRAWSURFACE7 lpDDS, int iItems, RECT rBBox, POINT Pos)
{
...
void GameMenu::DrawMenu(LPDIRECTDRAWSURFACE7 lpDDS)
{
	...
	for (int i = 0; i < iNrItems; i++)
	{
		...
		lpDDS->BltFast(Position.x, Position.y + (MENU_STEP_Y*i), lpDDSMenuItemsSource, &r, DDBLTFAST_SRCCOLORKEY | DDBLTFAST_WAIT);
